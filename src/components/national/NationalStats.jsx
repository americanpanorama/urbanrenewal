          ...
          { (this.props.selectedYear == 1953) ? 
            ...
            (this.props.selectedYear == 1959) ? 
              <div>
                ...
                <p>The largest urban renewal project in Texas was located in the far west of the state in the comparatively small city of Lubbock. There the city's <span onClick={ this.props.onProjectClick } id={3821}>Coronado project</span> displaced nearly 1300 African American families.</p>
              </div> : 
